...
class RobotiqGripper:
    ...
    def _get_var(self, var) -> int:
        ...
        value = int(
            value_str)  # we assume the value is an integer, which is the case for all variables we currently use. This may need to be adapted if we want to read variables that return non-integer values.
        return value
