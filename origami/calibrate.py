...
def main():
    left_arm = Arm.real("left", config.LEFT_ARM_IP, config.left_calibration(),
                        config=ArmConfig(home=config.LEFT_ARM_START_JOINTS, away=config.LEFT_ARM_AWAY_JOINTS), gripper_ip=config.LEFT_ARM_IP, gripper_port=config.GRIPPER_PORT)
    right_arm = Arm.real("right", config.RIGHT_ARM_IP, config.right_calibration(),
                         config=ArmConfig(home=config.RIGHT_ARM_START_JOINTS, away=config.RIGHT_ARM_AWAY_JOINTS), gripper_ip=config.RIGHT_ARM_IP, gripper_port=config.GRIPPER_PORT)
